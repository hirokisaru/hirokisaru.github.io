...
lockTable = JSON.parse(localStorage.getItem("lockT5"));
                                            // JustTry*** 
                                            //must edit
...
varCallStaff = JSON.parse(localStorage.getItem("jsonCallStaffT5")); 
                                                    // JustTry***
                                                    //must edit
...
function confirmkTable1SetS(){
    ...
    var cfmkTable1SetS = window.confirm("Please confirm?\nよろしいですか？\nโปรดยืนยัน");
        ...
        if (cfmkTable1SetS) {
                ...
                localStorage.setItem("kTable5Item", JSON.stringify(orderTable1MenuList));
                                        // JustTry***
                                        //must edit                     //must edit
                localStorage.setItem("kTable5Pay", JSON.stringify(orderTable1MenuList));
                                        // JustTry***
                                        //must edit                     //must edit
                lockTable = true;
                console.log("lockTable");
                console.log(lockTable);
                localStorage.setItem("lockT5", JSON.stringify(lockTable));
                                        // JustTry***
                                        //must edit
                console.log("orderTable1MenuList");
                                        //must edit
...
function funcCallStaff(){
    ...
    varCallStaff = true;
    localStorage.setItem("jsonCallStaffT5", JSON.stringify(varCallStaff));
                                // JustTry***
                                //must edit
