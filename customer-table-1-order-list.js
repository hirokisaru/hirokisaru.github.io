...
lockTable = JSON.parse(localStorage.getItem("lockT1"));
                                            // JustTry*** 
                                            //must edit
...
varCallStaff = JSON.parse(localStorage.getItem("jsonCallStaffT1")); 
                                                    // JustTry***
                                                    //must edit
...
function confirmkTable1SetS(){
    ...
    var cfmkTable1SetS = window.confirm("Please confirm?\nよろしいですか？\nโปรดยืนยัน");
        ...
        if (cfmkTable1SetS) {
                ...
                localStorage.setItem("kTable1Item", JSON.stringify(orderTable1MenuList));
                                        // JustTry***
                                        //must edit                     //must edit
                localStorage.setItem("kTable1Pay", JSON.stringify(orderTable1MenuList));
                                        // JustTry***
                                        //must edit                     //must edit
                lockTable = true;
                console.log("lockTable");
                console.log(lockTable);
                localStorage.setItem("lockT1", JSON.stringify(lockTable));
                                        // JustTry***
                                        //must edit
                console.log("orderTable1MenuList");
                                        //must edit
...
function funcCallStaff(){
    ...
    varCallStaff = true;
    localStorage.setItem("jsonCallStaffT1", JSON.stringify(varCallStaff));
                                // JustTry***
                                //must edit
