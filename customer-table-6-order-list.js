...
lockTable = JSON.parse(localStorage.getItem("lockT6"));
                                            // JustTry*** 
                                            //must edit
...
varCallStaff = JSON.parse(localStorage.getItem("jsonCallStaffT6")); 
                                                    // JustTry***
                                                    //must edit
...
function confirmkTable1SetS(){
    ...
    var cfmkTable1SetS = window.confirm("Please confirm?\nよろしいですか？\nโปรดยืนยัน");
        ...
        if (cfmkTable1SetS) {
                ...
                localStorage.setItem("kTable6Item", JSON.stringify(orderTable1MenuList));
                                        // JustTry***
                                        //must edit                     //must edit
                localStorage.setItem("kTable6Pay", JSON.stringify(orderTable1MenuList));
                                        // JustTry***
                                        //must edit                     //must edit
                lockTable = true;
                console.log("lockTable");
                console.log(lockTable);
                localStorage.setItem("lockT6", JSON.stringify(lockTable));
                                        // JustTry***
                                        //must edit
                console.log("orderTable1MenuList");
                                        //must edit
...
function funcCallStaff(){
    ...
    varCallStaff = true;
    localStorage.setItem("jsonCallStaffT6", JSON.stringify(varCallStaff));
                                // JustTry***
                                //must edit
