...
lockTable = JSON.parse(localStorage.getItem("lockT2"));
                                            // JustTry*** 
                                            //must edit
...
varCallStaff = JSON.parse(localStorage.getItem("jsonCallStaffT2")); 
                                                    // JustTry***
                                                    //must edit
...
function clickOrderTable1MenuList0() {
    ...
    document.getElementById("table1CalDisplay").innerHTML = "¥"+orderTable1cal;
        ...
        alert("Please call our staff in case you would like to order more than 10.\n10品以上ご注文をご希望の場合は店員をお呼びください。\nโปรดเรียกพนักงานกรณีต้องการสั่งมากกว่า10รายการ");
...
function confirmkTable1SetS(){
    ...
    var cfmkTable1SetS = window.confirm("Please confirm?\nよろしいですか？\nโปรดยืนยัน");
        ...
        if (cfmkTable1SetS) {
                ...
                localStorage.setItem("kTable2Item", JSON.stringify(orderTable1MenuList));
                                        // JustTry***
                                        //must edit                     //must edit
                localStorage.setItem("kTable2Pay", JSON.stringify(orderTable1MenuList));
                                        // JustTry***
                                        //must edit                     //must edit
                lockTable = true;
                console.log("lockTable");
                console.log(lockTable);
                localStorage.setItem("lockT2", JSON.stringify(lockTable));
                                        // JustTry***
                                        //must edit
                console.log("orderTable1MenuList");
                                        //must edit
...
function funcCallStaff(){
    ...
    varCallStaff = true;
    localStorage.setItem("jsonCallStaffT2", JSON.stringify(varCallStaff));
                                // JustTry***
                                //must edit
